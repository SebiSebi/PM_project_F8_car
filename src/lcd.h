...
// Portul pe care conectam anodul pentru backlight
#define LcdBACK_LIGHT_DDR	DDRC
#define LcdBACK_LIGHT_PORT	PORTC
#define LcdBACK_LIGHT_PIN	PINC

// Pinul pentru anodul backlight-ului
#define LcdAnode		PC2			
...
// Mask pentru bitul de anod la backlight
#define LCD_ANODE_MASK		(_BV(LcdAnode))
